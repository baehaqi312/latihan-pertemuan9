<footer class="footer">
    ...
    <div class="h4 title text-center">Luthfi Baehaqi</div>
    <div class="text-center text-muted">
        <p>&copy; Creative By Luthfi Baehaqi. All rights reserved.<br />NIM - <a class="credit" href="https://templateflip.com" target="_blank">2157401014</a></p>
    </div>
</footer>
